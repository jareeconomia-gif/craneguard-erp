...
(async()=>{try{
  ...
  installClientsApiHook(); installOperationsApiHook(); installEnterpriseApiHook(); installOfflineRoutesHook(); installOfflineAuditHook();
